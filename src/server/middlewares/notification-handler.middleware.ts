...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'post.create': {
    roles: ['administrator', 'content-manager', 'editor'],
    key: 'post-created',
    tenantPath: ['organization', 'post'],
    userPath: [],
  },
  'post.update': {
    roles: ['administrator', 'content-manager', 'editor'],
  ...
  'feature.update': {
    roles: ['administrator'],
    key: 'feature-updated',
    tenantPath: ['organization', 'feature'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['administrator', 'content-manager', 'editor'];
